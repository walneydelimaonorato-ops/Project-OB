	...
	match localfocus:
		...
		"Ready Brace":
			if !Global.Player_Data.Inv_Brace_Equiped == "null":
				Global.Inventory_Data.Brace_ID[Global.Player_Data.Inv_Brace_Equiped]["equipped?"] = false
		...
		"Ready Tool Left":
			if !Global.Player_Data.Inv_ToolL_Equiped == "null":
				Global.Inventory_Data.Tool_ID[Global.Player_Data.Inv_ToolL_Equiped]["equipped?"] = false
		...
		"Ready Tool Right":
			if !Global.Player_Data.Inv_ToolR_Equiped == "null":
				Global.Inventory_Data.Tool_ID[Global.Player_Data.Inv_ToolR_Equiped]["equipped?"] = false
		...
		"Ready UItem 1":
			if !Global.Player_Data.Inv_Uitem1_Equiped == "null":
				Global.Inventory_Data.UItem_ID[Global.Player_Data.Inv_Uitem1_Equiped]["equipped?"] = false
		...
		"Ready UItem 2":
			if !Global.Player_Data.Inv_Uitem2_Equiped == "null":
				Global.Inventory_Data.UItem_ID[Global.Player_Data.Inv_Uitem2_Equiped]["equipped?"] = false
		...
		"Ready UItem 3":
			if !Global.Player_Data.Inv_Uitem3_Equiped == "null":
				Global.Inventory_Data.UItem_ID[Global.Player_Data.Inv_Uitem3_Equiped]["equipped?"] = false
